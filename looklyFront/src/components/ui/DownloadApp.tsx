...
const DownloadApp = () => {
  return (
    <section id="download" className="py-20 bg-gradient-to-br from-[#6c63ff]/10 to-neutral-50">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto bg-neutral-50 rounded-2xl shadow-lg overflow-hidden">
          <div className="flex  md:flex-row">
            ...
            <div className="md:w-1/2 p-8 bg-[#6c63ff] from-[#6c63ff] to-blue-500 flex items-center justify-center">
