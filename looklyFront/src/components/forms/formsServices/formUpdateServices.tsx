...
function UpdateServices({ servicio, onActualizar }) {
    ...
    useEffect(() => {
        if (servicio) {
            ...
            setPrice(servicio.price);
            setDuration(servicio.duration_minutes);
        }
    }, [servicio]);
    ...
    const handleSubmit = (e) => {
        ...
        fetch(`http://localhost:8000/services/services/${servicio.id}/`, {
            method: "PATCH",
            headers: {
            ...
            <div>
                <div className="space-y-6 animate-fade-in ">
                    <div className="text-left mb-6  ">
                        ...
                        <h1 className="text-3xl font-bold text-foreground"> Modificación de tu servicio</h1>
                        <p className="text-muted-foreground mt-1"> Actualiza los datos esenciales de tu servicio.</p>
                    </div>
