    ...
    <Dialog >
      ...
      <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto bg-white border border-gray-300 transition-shadow">
        ...
        <div className="space-y-4 text-sm text-gray-700">
          <section>
            <h3 className="font-semibold text-lg mb-2 text-violet-600">Nuestra Historia</h3>
          ...
          <section>
            <h3 className="font-semibold text-lg mb-2 text-violet-600">Nuestra Misión</h3>
          ...
          <section>
            <h3 className="font-semibold text-lg mb-2 text-violet-600">Nuestra Visión</h3>
          ...
          <section>
            <h3 className="font-semibold text-lg mb-2 text-violet-600">Nuestros Valores</h3>
          ...
          <section>
            <h3 className="font-semibold text-lg mb-2 text-violet-600">Nuestro Equipo</h3>
