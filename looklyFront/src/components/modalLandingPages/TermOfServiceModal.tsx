    ...
    <Dialog>
      ...
      <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto bg-white border border-gray-300 transition-shadow">
        ...
        <div className="space-y-4 text-sm text-gray-700">
          <section>
            <h3 className="font-semibold text-lg mb-2 text-[#6c63ff]">1. Aceptación de los Términos</h3>
          ...
          <section>
            <h3 className="font-semibold text-lg mb-2 text-[#6c63ff]">2. Descripción del Servicio</h3>  
          ...
          <section>
            <h3 className="font-semibold text-lg mb-2 text-[#6c63ff]">3. Registro de Usuario</h3>
          ...
          <section>
            <h3 className="font-semibold text-lg mb-2 text-[#6c63ff]">4. Uso Aceptable</h3>
          ...
          <section>
            <h3 className="font-semibold text-lg mb-2 text-[#6c63ff]">5. Política de Cancelación</h3>
          ...
          <section>
            <h3 className="font-semibold text-lg mb-2 text-[#6c63ff]">6. Limitación de Responsabilidad</h3>
