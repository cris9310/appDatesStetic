    ...
    <Dialog>
      ...
      <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto bg-white border border-gray-300 transition-shadow">
        ...
        <div className="space-y-4 text-sm text-gray-700">
          <section>
            <h3 className="font-semibold text-lg mb-2 text-violet-600">¿Qué son las Cookies?</h3>
          ...
          <section>
            <h3 className="font-semibold text-lg mb-2 text-violet-600">Tipos de Cookies que Utilizamos</h3>
            
            <div className="space-y-3">
              <div>
                <h4 className="font-medium text-violet-600">Cookies Esenciales</h4>
          ...
          <section>
            <h3 className="font-semibold text-lg mb-2 text-violet-600">Gestión de Cookies</h3>
          ...
          <section>
            <h3 className="font-semibold text-lg mb-2 text-violet-600">Cookies de Terceros</h3>
          ...
          <section>
            <h3 className="font-semibold text-lg mb-2 text-violet-600">Duración de las Cookies</h3>
