...
import { Scissors, CircleDollarSign, Clock8, ChevronLeft } from "lucide-react-native";
...
function UpdateServices() {
    ...
    const getLocationService = async () => {
        try {
            ...
            const res = await fetch(
                `${API_URL}/companies/locations/${serviceId}/`,
                {
                    headers: {
    ...
    const validateForm = () => {
        ...
        if (!duration_minutes) errors.duration_minutes = true;
            ...
            >
                ...
                <View style={[styles.container, { marginTop: 20, paddingTop: 35 }]}>
                    ...
                    <View style={styles.cardTitle}>
                        ...
                        <Text style={styles.labeltittle}>Creación de servicios</Text>
                    </View>
                    <View style={styles.containerSub}>
                        ...
                        <View>
                            <View >
                                ...
                                ]} placeholder="Nombre del servicio" onChangeText={setName} />
                            </View>
                            <View >
                                <View style={styles.inputTitle}>
                                    <Scissors size={22} color="#6c63ff" />
